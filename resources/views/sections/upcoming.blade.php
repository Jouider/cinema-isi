      ...
      <ul class="movies-list  has-scrollbar">
          ...
          <div class="movie-card">
            ...
            <a href="./movie-details.html">
              <figure class="card-banner">
                <img src="{{asset('assets/images/upcoming-1.png')}}" alt="The Northman movie poster">
              </figure>
            </a>
        ...
        <li>
          <div class="movie-card">
            ...
            <a href="./movie-details.html">
              <figure class="card-banner">
                <img src="{{asset('assets/images/upcoming-2.png')}}"
        ...
        <li>
          <div class="movie-card">
            ...
            <a href="./movie-details.html">
              <figure class="card-banner">
                <img src="{{asset('assets/images/upcoming-3.png')}}" alt="Memory movie poster">
              </figure>
            </a>
        ...
        <li>
          <div class="movie-card">
            ...
            <a href="./movie-details.html">
              <figure class="card-banner">
                <img src="{{asset('')}}assets/images/upcoming-4.png"
