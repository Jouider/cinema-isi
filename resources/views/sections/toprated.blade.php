              ...
              <ul class="movies-list">
                  ...
                  <div class="movie-card">
                    ...
                    <a href="./movie-details.html">
                      <figure class="card-banner">
                        <img src="{{asset('')}}assets/images/movie-1.png" alt="Sonic the Hedgehog 2 movie poster">
                      </figure>
                    </a>
                ...
                <li>
                  <div class="movie-card">
                    ...
                    <a href="./movie-details.html">
                      <figure class="card-banner">
                        <img src="{{asset('')}}assets/images/movie-2.png" alt="Morbius movie poster">
                      </figure>
                    </a>
                ...
                <li>
                  <div class="movie-card">
                    ...
                    <a href="./movie-details.html">
                      <figure class="card-banner">
                        <img src="{{asset('')}}assets/images/movie-3.png" alt="The Adam Project movie poster">
                      </figure>
                    </a>
                ...
                <li>
                  <div class="movie-card">
                    ...
                    <a href="./movie-details.html">
                      <figure class="card-banner">
                        <img src="{{asset('')}}assets/images/movie-4.png" alt="Free Guy movie poster">
                      </figure>
                    </a>
                ...
                <li>
                  <div class="movie-card">
                    ...
                    <a href="./movie-details.html">
                      <figure class="card-banner">
                        <img src="{{asset('')}}assets/images/movie-5.png" alt="The Batman movie poster">
                      </figure>
                    </a>
                ...
                <li>
                  <div class="movie-card">
                    ...
                    <a href="./movie-details.html">
                      <figure class="card-banner">
                        <img src="{{asset('')}}assets/images/movie-6.png" alt="Uncharted movie poster">
                      </figure>
                    </a>
                ...
                <li>
                  <div class="movie-card">
                    ...
                    <a href="./movie-details.html">
                      <figure class="card-banner">
                        <img src="{{asset('')}}assets/images/movie-7.png" alt="Death on the Nile movie poster">
                      </figure>
                    </a>
                ...
                <li>
                  <div class="movie-card">
                    ...
                    <a href="./movie-details.html">
                      <figure class="card-banner">
                        <img src="{{asset('')}}assets/images/movie-8.png" alt="The King's Man movie poster">
                      </figure>
                    </a>
